...
export const stories: Story[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'His plan was simple: rob the grocery store, jump on a bicycle hidden nearby, and disappear into the night before the police arrived.',
  ...
  },
  {
    ...
    paragraphs: [
      'The city courtroom was completely packed because everyone wanted to watch the famous “Comedy Trial” between Officer Tom and robber Billy.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'One afternoon, Linda stopped at a coffee shop and immediately noticed a suspicious man sitting near the window. His mustache was crooked, obviously fake, and slowly falling into his soup.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'In the final vote, the jury announced that the true winner of the night was “whoever ordered the snacks.”',
